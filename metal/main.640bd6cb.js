...
document.querySelectorAll('form').forEach(function (form) {
  return form.addEventListener('submit', function (event) {
    ...
    if (form.classList.contains('models-form')) document.querySelector('#model').classList.add('visible');else document.querySelector('#thanks').classList.add('visible');
  });
});
...
document.querySelectorAll('#section-11 button').forEach(function (button) {
  return button.addEventListener('click', function () {
    return document.querySelector('#task-solving').classList.add('visible');
  });
});
...
document.querySelectorAll('button.upload-btn').forEach(function (btn) {
...
},{"@glidejs/glide":194,"smoothscroll":196}],135:[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + '35438' + '/');
